...
const ru = {
  ...
  support: {
    ...
    faq_interest_only_q: "Что такое \"Только интерес\"?",
    faq_interest_only_a: "Функция \"Только интерес\" позволяет вам показать только проекты, которые соответствуют вашим интересам. Это помогает вам быстрее найти подходящие проекты для участия или инвестирования."
  },
